...
Version 0.9.8 of *PMT* introduced functionality for *masternode owners* (MNOs) to review and cast votes on current proposals. In addition to MNOs, this feature is also useful to *proposal owners*, who can use it to track and analyze voting progress on their proposals.
...
![Proposals window](img/pmt-proposals-window.png)
...
![Column selection dialog](img/pmt-proposals-columns.png)
 ...
 * Cast a vote on proposals (if a masternode is configured in *PMT*).
 ...
 * A chart summarizing YES, NO and ABSTAIN vote counts.  
    ![Voting history tab](img/pmt-proposals-voting-history.png)  

    Vote change chart:  
    ![Vote change chart](img/pmt-proposals-vote-change-chart.png)  

    Vote summary chart:  
    ![Vote summary chart](img/pmt-proposals-vote-summary-chart.png)

### Casting votes

In the main proposals list, select the proposal(s), you'd like to vote on.

> Note: from PMT v0.9.18 you can select and vote on multiple proposals
...
![Vote tab](img/pmt-proposals-vote.png)
...
![Vote tab](img/pmt-proposals-vote-2.png)
