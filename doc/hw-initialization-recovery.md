 ...
 * [Hardware wallet initialization and recovery in PMT](#hardware-wallet-initialization-and-recovery-in-pmt)
 ...
 * [Running PMT on an offline Linux system](hw-initr-live-cd-linux.md)
...
## Hardware wallet initialization and recovery in PMT

All functionality described in this chapter is available in the `Hardware wallet initialization/recovery` dialog, launched from the `Tools` menu of PMT. The application will guide you through the steps using a standard wizard-style dialog, where interaction with the user is divided into separate steps.
